...
export function hideFlowchart() {
    overlayEl?.classList.remove('active');
}
/** Clean up the overlay element */
export function destroyFlowchart() {
    overlayEl?.remove();
    overlayEl = null;
}
// -------------------------------------------------------------------
...
function renderFlowchartContent() {
    if (!overlayEl || !currentEngine)
        return;
    overlayEl.innerHTML = '';
...
// Module Progress Bar
// -------------------------------------------------------------------
function renderModuleProgress(container) {
    if (!currentEngine)
        return;
...
// Path Trace
// -------------------------------------------------------------------
function renderPathTrace(container) {
    if (!currentEngine)
        return;
    const session = currentEngine.getSession();
    if (!session)
...
function createPathNode(node, answer, status, historyIndex) {
